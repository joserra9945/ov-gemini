...
const validCIF = (cif: string) => {
  ...
  for (i = 0; i < digits.length; i += 1) {
    ...
    if (i % 2 === 0) {
      digit *= 2;
      if (digit > 9) {
        digit = parseInt((digit / 10) as unknown as string, 10) + (digit % 10);
      }
...
export const validateSpanishID = (str: string): boolean => {

...
import DropdownPassThrough from './DropdownPT';

export const PaginatorPassThrough: PaginatorPassThroughOptions = {
  root: {
    className: classNames(
      'flex flex-row justify-center md:justify-end items-center  flex-wrap',
  ...
  RPPDropdown: {
    ...
    root: ({ props, state }: DropdownPassThroughMethodOptions) => ({
      className: classNames(
        'h-10 cursor-pointer inline-flex relative select-none mr-2',
